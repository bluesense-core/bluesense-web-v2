...
const CassavaProducer = ({
    ...
    const data = blogs.items.filter(
        (e) => e.title === 'Nigeria is the Biggest Cassava Producer in the World. Why isn’t it Cashing in on the Global Market?'
    );
...
export default CassavaProducer;
