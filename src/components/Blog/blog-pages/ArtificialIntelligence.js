...
const ArtificialIntelligence = ({
    ...
    const data = blogs.items.filter(
        (e) => e.title === 'Harnessing the Power of Artificial Intelligence to Simplify Bookkeeping'
    );
    const finalBlog = data[0];

    const shuffledData = blogs.items
        .filter((e) => e.title !== 'Harnessing the Power of Artificial Intelligence to Simplify Bookkeeping')
