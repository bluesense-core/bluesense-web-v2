...
const partners = [
    ...
    },
    {
        ...
        desc: 'Ololade has a Masters in Data Science and Business Analytics with keen interest in optimising business processes and operations to yield maximum profit using Data Science and Data Analytical tools. She has a track record of using data science and data analytics tools like Python, R tidyverse, SQL, No SQL and Tableau efficiently and accurately.',
